...
sub holoshare2	{
		system  "ssh -f -N -R 11200:localhost:$serverport -L 9001:localhost:11221 $dmzbox";
		system "$holobin -root $holoroot -mpcfile $mpconfig -server\:$serverport -client\:localhost\:9001 -nosettings -nosession $dataset";
		}	
sub holoshare3	{
		system "ssh -f -N -R 11200:localhost:$serverport -L 9001:localhost:11221 -L 9002:localhost:9992 sshdmz"; 
